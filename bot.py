...
async def on_message(message):
    ...
    if message.content.startswith(config["bot_prefix"] + 'whois'):
        ...
        embed.set_footer(text="Bot created by <@624633250232401961> https://markiemm.com")
        await message.channel.send(embed=embed)
        early_access_message=discord.Embed(title="A notice from the developer", description="This bot is currently in its early stages of development with only a very few commands available at this time. \n \n This bot may go offline at times while the developer <@624633250232401961> is still working on it and adding new features as well as making it stable and reliable. This is not the final product. ", color=0xff7024)
    ...
    if message.content.startswith(config["bot_prefix"] + "fullwhois"):
        ...
        while True:
            try:
                ...
                embed=discord.Embed(title="OOPS!", description="```" + "Sorry, there was an error processing your request. Please try again later or contact <@624633250232401961>" + "```", color=0xf40101)
                embed.set_author(name="Pencord", icon_url="https://cdn.discordapp.com/attachments/860495176488452097/863506691277717564/DB-Icons-Pen-Testing.png")
